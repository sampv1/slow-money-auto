...
export const INDICATORS: IndicatorSpec[] = [
  ...
  { key: "ma_stage_2_alignment", category: "trend", direction: "bullish",
    label_en: "Stage 2 alignment (MA50>MA150>MA200)", label_vi: "Xếp lớp Stage 2 (MA50>MA150>MA200)" },
  { key: "ma_stage_4_alignment", category: "trend", direction: "bearish",
    label_en: "Stage 4 alignment (MA50<MA150<MA200)", label_vi: "Xếp lớp Stage 4 (MA50<MA150<MA200)" },
