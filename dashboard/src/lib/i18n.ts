...
export const translations = {
  en: {
    ...
    finFeaturedReset: "Back to chart 1 (Esc)",
    ...
    baFormDescription: "Markdown commentary shown on the Analysis page for one symbol. Load the symbol first so an edit starts from what is already stored.",
    baLoad: "Load",
    baLoading: "Loading...",
    baLoaded: "Loaded the stored note.",
    baLoadedEmpty: "No note stored for this symbol yet.",
    baSave: "Save",
    baSaving: "Saving...",
    baSaved: "Saved. The Analysis page shows it now.",
    baDeleted: "Emptied — the block no longer shows for this symbol.",
    ...
    baEmptyDeletes: "Saving an empty box removes the note and hides the block.",
    baUpdatedAt: "Updated",
    baMismatch: "The text in the box was loaded for a different symbol:",
    baDelete: "Delete",
    baCancel: "Cancel",
    ...
    baDeleting: "Deleting...",
    baNothingToDelete: "There was nothing stored for that symbol.",
  ...
  vi: {
    ...
    finFeaturedReset: "Về biểu đồ 1 (Esc)",
    finQuarterly: "Quý",
    finTtm: "TTM",
    finAnnual: "Năm",
    finSpanAll: "Tất cả",
    ...
    baFormDescription: "Nội dung markdown hiển thị trên trang Phân tích của một mã. Hãy tải mã trước để chỉnh sửa từ nội dung đang lưu.",
    baLoad: "Tải",
    baLoading: "Đang tải...",
    baLoaded: "Đã tải nội dung đang lưu.",
    baLoadedEmpty: "Mã này chưa có nội dung nào.",
    baSave: "Lưu",
    baSaving: "Đang lưu...",
    baSaved: "Đã lưu. Trang Phân tích đã hiển thị.",
    baDeleted: "Đã xóa — khối này không còn hiển thị cho mã đó.",
    ...
    baEmptyDeletes: "Lưu khi ô trống sẽ xóa nội dung và ẩn khối này.",
    baUpdatedAt: "Cập nhật",
    baMismatch: "Nội dung trong ô được tải cho một mã khác:",
    baDelete: "Xóa",
    baCancel: "Hủy",
    ...
    baDeleting: "Đang xóa...",
    baNothingToDelete: "Mã đó không có nội dung nào được lưu.",
