...
export const translations = {
  en: {
    ...
    faMinNpatYoyHint: "% — hides names with no year-ago quarter to compare against; 0 turns it off",
  ...
  vi: {
    ...
    faMinNpatYoyHint: "% — ẩn mã không có quý cùng kỳ để so sánh; đặt 0 để tắt",
