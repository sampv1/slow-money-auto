...
export const translations = {
  en: {
    ...
    secProvisionalNote: "Thresholds are provisional (CTCK_V8) and not yet calibrated against a backtest.",
    secSymbols: "brokers",
  ...
  vi: {
    ...
    secProvisionalNote: "Ngưỡng điểm còn là bản tạm (CTCK_V8), chưa hiệu chỉnh theo backtest.",
    secSymbols: "mã",
