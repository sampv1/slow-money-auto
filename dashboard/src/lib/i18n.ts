...
export const translations = {
  en: {
    ...
    faReBand: "Band",
    faReCoveragePartialNote: "an input was missing, so that criterion was not scored",
    faReCoverageBelowFloor: "too little data to compare — excluded from the Final Score",
  ...
  vi: {
    ...
    faReBand: "Khung điểm",
    faReCoveragePartialNote: "thiếu dữ liệu đầu vào nên tiêu chí đó không được chấm",
    faReCoverageBelowFloor: "quá ít dữ liệu để so sánh — bị loại khỏi Điểm tổng",
