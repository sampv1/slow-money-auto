...
export const translations = {
  en: {
    ...
    secGroupCapital: "Capital safety",
    ...
    secSumShareUnknown: "Not determined",
  ...
  vi: {
    ...
    secSumDriver: "Động lực nổi bật",
    secSumRisk: "Rủi ro chính",
    secSumMarginGrowth: "Tăng trưởng dư nợ MG",
    ...
    secSumShareUnknown: "Chưa xác định",
