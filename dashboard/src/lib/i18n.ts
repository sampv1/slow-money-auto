...
export const translations = {
  en: {
    ...
    secSumQualityAssumption: "The three quality columns read C13, C8 and C9 — the criteria the rubric's own dictionary names \u201casset quality\u201d, \u201coperating efficiency\u201d and \u201ccapital safety\u201d. The spec leaves their grouping blank; this reading is pending confirmation.",
    secC8: "Core CIR",
  ...
  vi: {
    ...
    secSumQualityAssumption: "Ba cột chất lượng đang đọc C13, C8 và C9 — đúng các tiêu chí mà từ điển của bộ lọc gọi là \u201cchất lượng tài sản\u201d, \u201chiệu quả hoạt động\u201d và \u201can toàn vốn\u201d. Bảng đặc tả chưa ghi cách gộp nhóm; cách đọc này đang chờ BA xác nhận.",
    secC8: "CIR cốt lõi",
