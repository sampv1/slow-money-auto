...
export const translations = {
  en: {
    ...
    faAsOf: "as of",
    faQoqNotice: "QoQ-based scoring — YoY upgrade pending data source",
    faValuationLine: "Valuation",
    faEpsTtm: "EPS (TTM)",
    faPe4qMedian: "P/E 4Q median",
    faPrice: "Price",
    faUnrated: "Not rated — insufficient or unsupported data",
    // Criterion labels (QoQ in v1)
    faC1: "Latest Q EPS growth (QoQ)",
    faC2: "Avg EPS growth, last 3 (QoQ)",
    faC3: "Quarters with EPS growth",
    faC4: "Revenue growth (QoQ)",
    faC5: "Gross margin change (pp, QoQ)",
    faC6: "Net margin change (pp, QoQ)",
    faC7: "Return on Equity (TTM)",
    faC8: "Financial health (Debt/Equity)",
    faC9: "Valuation (P/E vs 4Q median)",
  ...
  vi: {
    ...
    faAsOf: "tính đến",
    faQoqNotice: "Chấm điểm theo QoQ — sẽ nâng cấp YoY khi có nguồn dữ liệu",
    faValuationLine: "Định giá",
    faEpsTtm: "EPS (4 quý)",
    faPe4qMedian: "P/E trung vị 4 quý",
    faPrice: "Giá",
    faUnrated: "Chưa xếp hạng — dữ liệu thiếu hoặc không hỗ trợ",
    // Criterion labels (QoQ in v1)
    faC1: "Tăng trưởng EPS quý mới nhất (QoQ)",
    faC2: "Tăng trưởng EPS bình quân 3 quý (QoQ)",
    faC3: "Số quý EPS tăng trưởng",
    faC4: "Tăng trưởng doanh thu (QoQ)",
    faC5: "Thay đổi biên LN gộp (điểm %, QoQ)",
    faC6: "Thay đổi biên LN ròng (điểm %, QoQ)",
    faC7: "Tỷ suất sinh lời VCSH (TTM)",
    faC8: "Sức khỏe tài chính (Nợ/VCSH)",
    faC9: "Định giá (P/E so với trung vị 4 quý)",
