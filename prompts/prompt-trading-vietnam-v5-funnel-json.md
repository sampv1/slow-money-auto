...
4. Nếu không xác định được chắc chắn giá đóng cửa là giá đóng cửa của phiên gần nhất, không khuyến nghị mã đó
5. Nếu KB3 (ĐỨNG NGOÀI): recommendations = [] (mảng rỗng)
6. Giá tính bằng VND, % tính dạng số thực (5.5 = 5.5%)
7. Ngày định dạng YYYY-MM-DD
8. 🚫 KHÔNG ĐƯỢC dùng null cho các trường bắt buộc trong recommendations:
