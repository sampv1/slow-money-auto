...
1. **Bước 1 (5-10 phút):** Chạy prompt Sentiment v2 để lấy CSS và tin tức
2. **Bước 2 (15-20 phút):** Chạy prompt Trading v5 này
   - Context bổ sung: CSS từ Bước 1, vị thế đang giữ, vốn trading
3. **Bước 3:** Đọc kỹ Phần 4 (câu chuyện + priced in) — đây là phần đặc biệt của v5
4. **Bước 4:** Nếu có Final List → kiểm tra giá trên app CTCK trước khi đặt lệnh
5. **Bước 5:** Nếu KB3 (đứng ngoài) → chấp nhận, không ép buộc
