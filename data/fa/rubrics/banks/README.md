# Banks rubric — planned, not built

Banks currently score **UNRATED**: the manufacturing rubric's margin
criteria (gross margin, net margin, EBITDA margin) do not apply to a bank's
...
1. `fa_industry.industry_group` gains `banks` — the check constraint already
